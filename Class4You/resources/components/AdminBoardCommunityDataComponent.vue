        ...
        <div id="wrapper">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="/adminboardcommunitydata">커뮤니티 게시글 리스트</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <p class="mb-4">해당 정보는 커뮤니티에 남긴 게시물에 대한 정보를 출력합니다. </p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div style="display: flex; align-items: center; justify-content: space-between;" class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">커뮤니티 게시글 테이블</h6>
                            <div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" style="text-align: center;" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr v-for="datas in boardCommunityData">
                                            <th>{{ datas.BoardCategoryID == 1 ? '자유' : datas.BoardCategoryID == 2 ? '질문' : '상태를 확인할 수 없음' }}</th>
                                            <th>{{ datas.BoardID }}</th>
                                            <th>{{ datas.UserID }}</th>
...
export default {
    name: 'AdminBoardCommunityDataComponent',
    ...
    methods: {
        fetchData(page = 1) {
            axios.get(`/instructoruserboardcommunity?page=${page}&search=${this.searchQuery}&searchPicked=${this.searchPicked}`)
            .then(response => {
