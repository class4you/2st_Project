...
<!-- 
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div>
                                ...
                                <form class="keyword-search-form">
                                    ...
                                    <div>
                                        <input v-model="searchPicked" name="type" type="radio" value="1" id="keyword-type-posts">
                                    ...
                                    <div>
                                        <input v-model="searchPicked" name="type" type="radio" value="2" id="keyword-type-special">
                                ...
                                <table style="display: flex; justify-content: center; gap: 8px;">
                                    <tbody v-for="(page, index) in pagination" :key="index">
                                        <template v-if="page.url !== null">
											<a class="qustuon_list_page_a" :class="{'page_on': page.label == pageChk}" @click.prevent="fetchData(page.label, searchQuery, searchPicked)" href="#">{{ replaceString(page.label) }}</a>
										</template>
										<template v-else>
            ...
            <div v-if="adminClassUserDataIsOpen" class="admin_class_user_data_modal">
                <div class="admin_class_user_data_modal-container" style="width: 60%;">
...
export default {
    ...
    methods: {
        fetchData(page = 1) {
            axios.get(`/instructorclassinsertdata?page=${page}&search=${this.searchQuery}&searchPicked=${this.searchPicked}`)
            .then(response => {
                // console.log('오냐');
